---
layout: post
title: "【LLM 日報】2026 年 07 月 15 日 — Codex 的加密黑洞、Anthropic 的加拿大佈局、以及 gwern 的守護天使藍圖"
date: 2026-07-15 00:05:00 +0000
categories: [llm, daily]
---

今天的 LLM 圈有兩個值得注意的動向：OpenAI 的 Codex CLI 在一個月前悄悄加密了子代理之間的通訊，審計軌跡從此黑箱；Anthropic 同一天向加拿大研究機構投入 1,000 萬加元，並為美國教師推出免費 Claude。而 gwern 則從另一端提出解法：與其對抗模型的自主意志，不如讓模型變成你的數位複製品。
